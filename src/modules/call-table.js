...
const definitions = [
  ...
  { name: 'render', aliases: ['R', 'comfy', 'comfy.render', 'comfy_render'], aiInput: { prompt: { type: 'string', required: true, maxLength: 4000 }, negative: { type: 'string', maxLength: 2000 }, iterations: { type: 'integer', min: 1, max: 10 }, seed: { type: 'integer', min: 0, max: 2147483647 } }, defaults: { workflow: 'settings.comfyWorkflow', negative: '', iterations: 'settings.comfyIters', seed: null }, scope: 'current-session', permission: 'external-effect', maxPerRound: 1, executor: 'comfy.render', resultFormatter: 'compactRenderResult' },
