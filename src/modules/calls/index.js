...
function createCalls(options = {}) {
  ...
  const visionService = options.visionService || createVisionService({
    ...
    visionAI,
    parseMetadata: typeof options.parseMetadata === 'function' ? options.parseMetadata : images?.parsePngMetadata,
...
module.exports = { RUNTIME_TOOL_NAMES, AGENT_RUNTIME_TOOL_NAMES, AGENT_ADMIN_TOOL_NAMES, createCalls, makeSchemas, artifact };
