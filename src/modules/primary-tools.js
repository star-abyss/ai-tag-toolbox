...
const characterSelectionSchema = schema({ query: nonempty, characterId: nonempty }, ['query', 'characterId']);
...
const DEFINITIONS = Object.freeze({
  ...
  'generation.resume': { description: '为处于 needs_input 或 interrupted 的生成任务补充原图、角色、工作流或策略后继续执行。角色选择必须原样回传上一次结果中的 jobId、needsInput.query 和所选 characterId。', parameters: generationResumeSchema, outputSchema: { type: 'object' } }
});
