...
function dataUrlBytes(value) {
  ...
  if (base64) {
    // Node's base64 decoder tolerates stray characters and padding variants, so
    // a full per-character validation pass is redundant and very slow on large
    // stored images (it blocked the renderer for over a second on launch).
    try {
