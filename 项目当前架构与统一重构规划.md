...
更新日期：2026-09-09。代码版本：**V1.4.239**。本文按当前源码核对，是后续开发的架构入口。

- 工作区：`F:\codex\ai-tag-characters`，分支 `feat/offline-characters-v198`。
- 桌面测试包：`C:\Users\admin\Desktop\AI绘画Tag工具箱V1.4.239`。
...
AI 翻译按钮在请求期间显示旋转加载图标和“AI 翻译中…”文字，设置 `aria-busy=true` 并保持禁用，避免用户误以为页面卡住；成功、失败、超时、取消都会恢复为可用的“AI 翻译”按钮。
...
本次交付说明：[V1.4.239](交付说明-V1.4.239.md)。提示词组接口详见 [Prompts README](src/modules/prompts.README.md)。
