...
assert.equal(packageJson.version, '1.4.32', 'package version must be 1.4.32');
assert.match(fs.readFileSync(path.join(root, 'VERSION.txt'), 'utf8'), /V1\.4\.32\b/);
assert.match(fs.readFileSync(path.join(root, 'src', 'index.html'), 'utf8'), /V1\.4\.32\b/);
